  ...
  <nav id="navbar" class="relative z-10 w-full text-neutral-800">
    <div class="flex flex-col max-w-screen-xl px-8 mx-auto lg:items-center lg:justify-between lg:flex-row py-4">
      <div class="flex flex-col lg:flex-row items-center space-x-4 xl:space-x-8">
        ...
        >
          <NavLink name="IBMinScut" url="#" />
          <NavLink name="Activities" url="#" />
          <NavLink name="Project/Contest" url="#" />
          <NavLink name="We" url="#" />
          <NavLink name="Board" url="#" />
          <li class="relative group">
            ...
            <transition name="transform-fade-down">
              ...
              >
                <li>
                  <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Campus Tips</a>
                </li>
                <li>
                  <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Technical sharing</a>
                </li>
                <li>
                  <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Knowledge</a>
                </li>
                <li>
                  <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Lecture&Lab</a>
                </li>
              </ul>
            </transition>
          </li>
