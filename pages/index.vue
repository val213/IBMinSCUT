<template>
  <div class="w-full">
    ...
    <section id="hero" class="w-full pb-24">
      <BaseSection>
        <div class="col-span-12 lg:col-span-6 mt-12 xl:mt-10 space-y-4 sm:space-y-6 px-6 text-center sm:text-left">
          ...
          >
            IBM in <span class="text-header-gradient">SCUT</span> club
          </h1>
          <p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" class="paragraph hidden sm:block">
           华工IBM俱乐部,致力于向华工的小伙伴们宣传IBM文化,培养创新精神,开阔科技视野。
          </p>
          <div
            data-aos="fade-up"
            data-aos-once="true"
        ...
        <div class="hidden sm:block col-span-12 lg:col-span-6">
          <div class="w-full">
            <img
              data-aos="fade-up"
              data-aos-once="true"
              :src="require('~/assets/img/IBM.jpg')"
              class="-mt-4"
              alt=""
            />
          </div>
    ...
    <section class="w-full my-24">
          <BaseSection>
            ...
            <div data-aos="fade-left" data-aos-delay="150" class="col-span-12 lg:col-span-6 px-4 sm:px-6 mt-8">
              <span class="text-base text-gradient font-semibold uppercase mb-4 sm:mb-2">IBMinSCUT</span>
              <h2 class="text-3xl sm:text-4xl font-semibold mb-10 sm:mb-6">华南理工大学IBM俱乐部</h2>
    ...
    <!-- Blog and Acticle -->
    <section class="max-w-screen-xl mx-2 sm:mx-auto px-4 sm:px-6 lg:px-0 py-6 pb-20 sm:py-8 rounded-[2.25rem] sm:rounded-xl bg-white shadow-lg sm:shadow-md transform lg:-translate-y-12">
    <h2 class="text-4xl font-semibold sm:pr-8 xl:pr-12">
      Blog and Acticle<br class="hidden sm:block" />
          </h2>
      <div class="w-full flex flex-col lg:flex-row items-center justify-center">
        <LandingCryptoStatistic
          ...
          title="🔥 Campus Tips"
          :datasets="trendings"
          class="xl:border-r border-gray-150 lg:px-6"
        />
        <LandingCryptoStatistic
          data-aos="fade-up"
          data-aos-delay="150"
    ...
    <section class="bg-partner relative max-w-full sm:mx-6 my-24 shadow sm:rounded-2xl overflow-hidden">
      <div class="w-full px-6 sm:px-0 py-16 flex flex-col items-center justify-center space-y-4 text-center">
        <h3 data-aos="flip-down" class="text-2xl text-neutral-800 font-semibold">特别鸣谢</h3>
        <p data-aos="flip-down" class="paragraph">华工IBM俱乐部的创立与经营有赖于以下组织和单位：</p>
        <div data-aos="fade-up" class="flex flex-wrap items-center justify-center">
          <LandingPartnerImage
            v-for="img in ['SCUT.png', 'software.png', 'swiss-finance.png', 'gambio.png']"
            :key="img"
            :img="img"
          />
        </div>
